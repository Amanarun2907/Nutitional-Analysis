...
try:
    ...
    model = XGBRegressor(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=42, n_jobs=-1)
    ...
    model_save_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'xgboost_model.joblib')

    # Save the trained model
    joblib.dump(model, model_save_path)
    print(f"\nTrained XGBoost Regressor model saved to: {model_save_path}")
    ...
    print("Please make sure you have pandas, scikit-learn, xgboost, and joblib installed.")
